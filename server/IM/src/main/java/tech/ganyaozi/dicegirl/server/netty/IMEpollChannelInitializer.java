...
public class IMEpollChannelInitializer extends ChannelInitializer<EpollServerSocketChannel> {
    ...
    public IMEpollChannelInitializer(ActorRef bussinessCenter) {
        this.bussinessCenter = bussinessCenter;
    }

    protected void initChannel(EpollServerSocketChannel serverChannel) throws Exception {
